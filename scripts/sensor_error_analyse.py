...
class DroneSensor:
    ...
    def synced_callback(self, rgb_msg,depth_msg,gimbal_msg,odemetry_msg,target_truth_msg):
        try:
            # 转换 RGB 图像
    ...
    def analyse_error(word_point_enu,target_truth_msg):
        rospy.loginfo("----------------analyse error---------------------")
        rospy.loginfo(word_point_enu)
